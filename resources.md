...
* Kitchens, J., Lemoie, K., & Schwartz, R. (2025) *Governance Framework for Issuer Identity Registries.* [{{ site.url | prepend: site.baseurl }}/docs/Governance-Framework-for-Issuer-Identity-Registries.pdf]({{ site.baseurl }}/docs/Governance-Framework-for-Issuer-Identity-Registries.pdf)
